...
```powershell
adb -s 2G0YC5ZHBF00R0 install -r -d Builds\QuestMmdPlayer.apk
adb -s 2G0YC5ZHBF00R0 shell pm grant com.QuestMMDPlayer.QuestMMDPlayerPrototype android.permission.RECORD_AUDIO
```
