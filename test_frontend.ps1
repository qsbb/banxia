...
$sourceChecks = @{
    ...
    "Assets/Scripts/UI/CompanionWorldMenu.cs" = @("TouchScreenKeyboard", "RefreshExternalActions", "ImportFile", "StopCurrentAction", "CompanionMenuInputBlocker", "open_model_list", "load_first_model", "capture_first_model", "run_vmd_qa", "vmd_scenario", "run_performance_qa", "performance_result", "[ModelCatalog] UI page=", "Device Performance Layer", "ShowPerformancePanel", "设备性能")
    "Assets/Scripts/UI/RuntimeDiagnosticsFormatter.cs" = @("BuildPanelText", "FormatMotion", "FormatPerformance", "SourceName", "AppendTimeline")
    "Assets/Scripts/Core/RuntimePerformanceMonitor.cs" = @("CalculateFrameStatistics", "SetDetailedSamplingEnabled", "userPresence", "FrameTimingManager", "Task.Run", "AttachCurrentThread", "PublishCompletedAndroidMetrics", "getPss", "getCurrentThermalStatus", "MMDPhysicsManager")
