...
$sourceChecks = @{
    ...
    "Assets/Scripts/UI/CompanionWorldMenu.cs" = @("TouchScreenKeyboard", "RefreshExternalActions", "ImportFile", "StopCurrentAction", "CompanionMenuInputBlocker", "open_model_list", "load_first_model", "capture_first_model", "run_vmd_qa", "vmd_scenario", "[ModelCatalog] UI page=", "Device Performance Layer", "ShowPerformancePanel", "设备性能")
